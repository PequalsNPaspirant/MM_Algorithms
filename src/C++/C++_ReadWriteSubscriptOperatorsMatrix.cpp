...
#include "C++/C++_ReadWriteSubscriptOperatorsMatrix.h"
...
namespace mm {
	...
	MM_DECLARE_FLAG(MatrixSubscriptOperators);

	MM_UNIT_TEST(MatrixSubscriptOperators_test_1, MatrixSubscriptOperators)
	{
