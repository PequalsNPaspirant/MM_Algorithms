...
*/
	...
	vector<Others_OMS_v3c::OrderTable> Others_OMS_v3c::OrderTableData(0);
	int Others_OMS_v3c::OrderTableDataIndex = -1;
	unordered_set<Others_OMS_v3c::OrderTable*, Others_OMS_v3c::HasherOrderTablePrimaryKeyClientSymbolId, Others_OMS_v3c::IsEqualOrderTablePrimaryKeyClientSymbolId> 
		Others_OMS_v3c::OrderTablePrimaryKeyClientSymbolId(0);
	unordered_multiset<Others_OMS_v3c::OrderTable*, Others_OMS_v3c::HasherOrderTableIndexSymbolId, Others_OMS_v3c::IsEqualOrderTableIndexSymbolId> 
		Others_OMS_v3c::OrderTablePositionIndexSymbolId(0);
	//TODO: add index on offset to get the sorted list at last
	// OR keep a running min heap and keep it updating
	set<Others_OMS_v3c::OrderTable*, Others_OMS_v3c::CompareOrderTableIndexOffset> Others_OMS_v3c::OrderTableSortIndexOffset;
	double Others_OMS_v3c::minOffsetInSortestList = 0.0;

	vector<Others_OMS_v3c::ClientTable> Others_OMS_v3c::ClientTableData(0);
	int Others_OMS_v3c::ClientTableDataIndex = -1;
	unordered_set<Others_OMS_v3c::ClientTable*, Others_OMS_v3c::HasherClientTablePrimaryKeyClientId, Others_OMS_v3c::IsEqualClientTablePrimaryKeyClientId> 
		Others_OMS_v3c::ClientTablePrimaryKeyClientId(0); // This is required in case clientId is not equal to index in ClientTableData
	unordered_set<Others_OMS_v3c::ClientTable*, Others_OMS_v3c::HasherClientTableIndexClientName, Others_OMS_v3c::IsEqualClientTableIndexClientName> 
		Others_OMS_v3c::ClientTableIndexClientName(0);

	vector<Others_OMS_v3c::SymbolTable> Others_OMS_v3c::SymbolTableData(0);
	int Others_OMS_v3c::SymbolTableDataIndex = -1;
	unordered_set<Others_OMS_v3c::SymbolTable*, Others_OMS_v3c::HasherSymbolTablePrimaryKeySymbolId, Others_OMS_v3c::IsEqualSymbolTablePrimaryKeySymbolId> 
		Others_OMS_v3c::SymbolTablePrimaryKeySymbolId(0); // This is required in case symbolId is not equal to index in SymbolTableData
	unordered_set<Others_OMS_v3c::SymbolTable*, Others_OMS_v3c::HasherSymbolTableIndexSymbolName, Others_OMS_v3c::IsEqualSymbolTableIndexSymbolName> 
		Others_OMS_v3c::SymbolTableIndexSymbolName(0);

#ifdef MM_DEBUG_OTHERS_EOMS
	vector<ClientSymbolPair> Others_OMS_v3c::finalSortedList;
#endif

	void Others_OMS_v3c::allocateAllMemory()
	{
	...
	void Others_OMS_v3c::deallocateAllMemory()
	{
...
/*
Same as previous algo, just removed the excessive optimization (see commented code below)
Complexity:
...
*/
	void Others_OMS_v3c::Others_OMS_addOrder(const string& clientName, const string& symbolName, double newOrderPrice)
	{
...
*/
	void Others_OMS_v3c::Others_OMS_updateMarketPrice(const string& symbolName, double currentMarketPrice)
	{
...
*/
	vector<string> Others_OMS_v3c::Others_OMS_getTop100v1()
	{
	...
	void Others_OMS_v3c::Others_OMS_getTop100v2(vector<const string*>& retVal)
	{
		int finalSortedListLen = std::min(100, OrderTableDataIndex + 1);
		if(OrderTableSortIndexOffset.size() < finalSortedListLen)
		{
