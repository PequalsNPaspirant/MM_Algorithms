...
namespace mm {
	...
	public:
		...
		static int MSBPosition_v2(unsigned int v)
		{
			...
			Endianness eLITTLE_ENDIAN = Endianness::little_endian;
			Endianness eBIG_ENDIAN = Endianness::big_endian;
			Endianness __FLOAT_WORD_ORDER = isLittleEndian_v1() ? eLITTLE_ENDIAN : eBIG_ENDIAN;
			...
			t.u[__FLOAT_WORD_ORDER == eLITTLE_ENDIAN] = 0x43300000;
			t.u[__FLOAT_WORD_ORDER != eLITTLE_ENDIAN] = v;
			t.d -= 4503599627370496.0;
			r = (t.u[__FLOAT_WORD_ORDER == eLITTLE_ENDIAN] >> 20) - 0x3FF;
