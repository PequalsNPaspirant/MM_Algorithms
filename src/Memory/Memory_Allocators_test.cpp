...
namespace mm {
	...
	void Memory_Allocators_unit_test(size_t iterations, size_t repeat)
	{
	...
	MM_DECLARE_FLAG(Memory_Allocators);
	...
	MM_UNIT_TEST(Memory_Allocators_unit_test_1, Memory_Allocators)
	{
		/*
		1,000 int = 4 KB
		1,000,000 int = 4 MB
		...
		*/
		...
		arena_v1<initialSize> a;
		Memory_Allocators_unit_test<int, Allocator, initialSize>(iterations, repeat);
